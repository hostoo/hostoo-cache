...
(function ($) {
	...
	jQuery(document).ready(function () {
		...
		$('#litespeed-crawl-url-btn').click(function () {
			...
			$('.litespeed-shell').removeClass( 'hostoo-hide' ) ;
		...
		$( '#litespeed-cdn-mapping-add' ).click(function(event) {
			...
			var toggle_items = cloned_item.find( '[data-hostoo-toggle-on]' ) ;

			var cls_off = 'hostoo-toggle-btn-' + toggle_items.data( 'hostoo-toggle-off' ) + ' litespeed-toggleoff' ;
			var cls_on = 'hostoo-toggle-btn-' + toggle_items.data( 'hostoo-toggle-on' ) ;
		...
		function litespeed_toggle() {
			$( '[data-hostoo-toggle-on]' ).off().click(function(event) {
				var cls_off = 'hostoo-toggle-btn-' + $( this ).data( 'hostoo-toggle-off' ) + ' litespeed-toggleoff' ;
				var cls_on = 'hostoo-toggle-btn-' + $( this ).data( 'hostoo-toggle-on' ) ;
