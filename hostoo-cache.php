...
if (! defined('HOSTOO_SERVER_TYPE')) {
    if (isset($_SERVER['HTTP_X_LSCACHE']) && $_SERVER['HTTP_X_LSCACHE']) {
        define('HOSTOO_SERVER_TYPE', 'HOSTOO_SERVER_ADC');
    } elseif (isset($_SERVER['LSWS_EDITION']) && strpos($_SERVER['LSWS_EDITION'], 'Openlitespeed') === 0) {
        define('HOSTOO_SERVER_TYPE', 'HOSTOO_SERVER_OLS');
    } elseif (isset($_SERVER['SERVER_SOFTWARE']) && $_SERVER['SERVER_SOFTWARE'] == 'LiteSpeed') {
        define('HOSTOO_SERVER_TYPE', 'HOSTOO_SERVER_ENT');
    } else {
...
if (! empty($_SERVER['X-LSCACHE']) ||  HOSTOO_SERVER_TYPE === 'HOSTOO_SERVER_ADC' || defined('HOSTOO_CLI')) {
    ! defined('HOSTOO_ALLOWED') &&  define('HOSTOO_ALLOWED', true);
}

// ESI const defination
if (! defined('HWCP_ESI_SUPPORT')) {
    define('HWCP_ESI_SUPPORT', HOSTOO_SERVER_TYPE !== 'HOSTOO_SERVER_OLS' ? true : false);
}
